    ...
    <div class="py-6 flex justify-center">
        <div class="w-full max-w-xl bg-white p-6 rounded-lg shadow-md border border-gray-200">
            ...
            <div class="py-4 flex justify-center">
                <input type="text" wire:model="userID" placeholder="User ID"
            ...
            <div class="py-4 flex justify-center">
                ...
                <div>
                    ...
                    @if ($image)
                        ...
                        <div class="mt-4 flex justify-center"> 
                            <button wire:click="scanVisualFace({{ $userID }})"
                    ...
                    <label class="flex items-center gap-2 bg-white w-full max-w-xs text-sm">
                        ...
                        <input type="checkbox" wire:model.live="visualfaceselected" value="1" class="checkbox" />
                    </label>
                    <label class="flex items-center gap-2 bg-white w-full max-w-xs text-sm">
        ...
        @endif
            <div class="py-4 flex justify-center">
                <label class="flex items-center gap-2 bg-white w-full max-w-xs text-sm">
                    ...
                    <select wire:model.live="selectDevice"
            ...
            <div class="py-4">
                @if (!empty($scanfinger))
                    <div class="flex gap-4 justify-center">
                        ...
                        @foreach ($fingerArray as $finger)
                        
                                @if ($index == 0 || $index == 1)
                                    <div
                                        class="w-40 h-40 border-2 border-gray-300 flex justify-center items-center shadow-md bg-white">
                                        @if (empty($finger['temp1image']))
                                            <span class="text-gray-500">No Image</span>
                                        @else
                                            <img src="data:image/bmp;base64,{{ $finger['temp1image'] }}"
                                                alt="Fingerprint Image" class="max-w-full max-h-full object-contain">
                                        @endif
                                    </div>
                                @endif

                                <button  wire:click="deleteFinger({{ $index }})" ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="red" class="size-6">
            ...
            <div class="py-4 flex justify-between gap-4">
                <button wire:click="addCard({{ $userID }})"
